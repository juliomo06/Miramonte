    ...
    const fetchWeddingResorts = async () => {
      try {
        const response = await axios.get(
          "http://localhost:8080/api/bookings/resorts?evfilter=Special Event"
        );
  ...
  return (
    <div className="bg-gray-50 min-h-full -z-10">
      <div className="flex flex-col items-center">
        <img
          className="absolute top-0 left-0 w-full h-[550px] object-buttom object-cover object-top brightness-50 z-[-1]"
          src={se}
          alt="background"
        />
